...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-container/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-container/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">56.76% <small>(42 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">48.98% <small>(24 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-container/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var containerWidth = $('.mj-container').data('width');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-container-outlook-open').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-container-outlook-line').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    $(this).replaceWith(_mjmlCore.helpers.startConditionalTag + '\n      &lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;\n      ' + _mjmlCore.helpers.endConditionalTag + '\n      ' + _mjmlCore.helpers.startConditionalTag + '\n      &lt;table role="presentation" border="0" cellpadding="0" cellspacing="0" width="' + containerWidth + '" align="center" style="width:' + containerWidth + 'px;"&gt;\n        &lt;tr&gt;\n          &lt;td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"&gt;\n      ' + _mjmlCore.helpers.endConditionalTag);</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-container-outlook-close').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    $(this).replaceWith(_mjmlCore.helpers.startConditionalTag + '\n      &lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;\n      ' + _mjmlCore.helpers.endConditionalTag);</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('body').css({ background: $('.mj-container').data('background-color') }).each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    if ($(this).attr('style') === '') {</span>
<span class="cstat-no" title="statement not covered" >      $(this).removeAttr('style');</span>
    }
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-container').removeAttr('data-background-color').removeAttr('data-width').removeAttr('class').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    if ($(this).attr('style') === '') {</span>
<span class="cstat-no" title="statement not covered" >      $(this).removeAttr('style');</span>
    }
  });
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Container);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Container.__proto__ || Object.getPrototypeOf(Container)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _helpers$widthParser = _mjmlCore.helpers.widthParser(mjAttribute('width')),</span>
