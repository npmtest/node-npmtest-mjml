...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-divider/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-divider/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-divider/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  $('.mj-divider-outlook').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    var insertNode = '&lt;table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="' + $(this).attr('style') + '" width="' + $(this).data('divider-width') + '"&gt;&lt;tr&gt;&lt;td style="height:0;line-height:0;"&gt;&amp;nbsp;&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    $(this).removeAttr('data-divider-width').removeAttr('class').after('' + _mjmlCore.helpers.startConditionalTag + insertNode + _mjmlCore.helpers.endConditionalTag);</span>
  });
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Divider);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Divider.__proto__ || Object.getPrototypeOf(Divider)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return _mjmlCore.helpers.merge({}, baseStyles, {</span>
    ...
    key: 'outlookWidth',
    value: <span class="fstat-no" title="function not covered" >function outlookWidth() {</span>
<span class="cstat-no" title="statement not covered" >      var mjAttribute = this.props.mjAttribute;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var parentWidth = parseInt(mjAttribute('parentWidth'));</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      switch (unit) {</span>
        case '%':
<span class="cstat-no" title="statement not covered" >          return parentWidth * width / 100;</span>
&nbsp;
        default:
...
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement('p', {</span>
