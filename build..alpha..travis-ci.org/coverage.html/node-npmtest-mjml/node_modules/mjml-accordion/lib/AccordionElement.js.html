...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-accordion/lib/AccordionElement.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-accordion/lib/AccordionElement.js</span></h1>
    <h2>
        
        Statements: <span class="metric">69.01% <small>(49 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-accordion/lib/</a> &#187; AccordionElement.js</div>
</div>
<div class="body">
...
&nbsp;
var findChildren = <span class="fstat-no" title="function not covered" >function findChildren(elements, tagName) {</span>
<span class="cstat-no" title="statement not covered" >  return (0, _find2.default)(elements, <span class="fstat-no" title="function not covered" >function (elem) {</span></span>
<span class="cstat-no" title="statement not covered" >    return elem.props.mjml.get('tagName') == tagName;</span>
  });
};
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function AccordionElement() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, AccordionElement);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (AccordionElement.__proto__ || Object.getPrototypeOf(AccordionElement)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var iconBackground = this.title &amp;&amp; this.title.props &amp;&amp; this.title.props.mjml &amp;&amp; this.title.props.mjml.get('attributes').get('background-color');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _mjmlCore.helpers.merge({}, baseStyles, {</span>
    ...
    key: 'renderIcons',
    value: <span class="fstat-no" title="function not covered" >function renderIcons() {</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.title = findChildren(children ? children.toArray() : [], 'mj-accordion-title');</span>
<span class="cstat-no" title="statement not covered" >      this.styles = this.getStyles();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var content = findChildren(children ? children.toArray() : [], 'mj-accordion-text');</span>
<span class="cstat-no" title="statement not covered" >      var accordionTitle = [this.title || _react2.default.createElement(_AccordionTitle2.default, null), this.renderIcons()];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
        'tr',
        null,
