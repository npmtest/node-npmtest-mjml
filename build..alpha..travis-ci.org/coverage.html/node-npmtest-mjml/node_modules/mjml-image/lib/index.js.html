...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-image/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-image/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">62.34% <small>(48 / 77)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-image/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Image.__proto__ || Object.getPrototypeOf(Image)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
  _createClass(Image, [{
    key: 'getContentWidth',
    value: <span class="fstat-no" title="function not covered" >function getContentWidth() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var parentWidth = mjAttribute('parentWidth');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var width = mjAttribute('width') ? (0, _min2.default)([parseInt(mjAttribute('width')), parseInt(parentWidth)]) : parseInt(parentWidth);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var paddingRight = getPadding('right');</span>
<span class="cstat-no" title="statement not covered" >      var paddingLeft = getPadding('left');</span>
<span class="cstat-no" title="statement not covered" >      var widthOverflow = paddingLeft + paddingRight + width - parseInt(parentWidth);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return widthOverflow &gt; 0 ? width - widthOverflow : width;</span>
    }
  }, {
    key: 'getStyles',
...
<span class="cstat-no" title="statement not covered" >      return _mjmlCore.helpers.merge({}, baseStyles, {</span>
    ...
    key: 'renderImage',
    value: <span class="fstat-no" title="function not covered" >function renderImage() {</span>
<span class="cstat-no" title="statement not covered" >      var mjAttribute = this.props.mjAttribute;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var img = _react2.default.createElement('img', {</span>
        alt: mjAttribute('alt'),
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (mjAttribute('href') != '') {</span>
