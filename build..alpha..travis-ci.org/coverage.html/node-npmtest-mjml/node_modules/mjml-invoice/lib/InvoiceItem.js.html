...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-invoice/lib/InvoiceItem.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-invoice/lib/InvoiceItem.js</span></h1>
    <h2>
        
        Statements: <span class="metric">68.75% <small>(44 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-invoice/lib/</a> &#187; InvoiceItem.js</div>
</div>
<div class="body">
...
&nbsp;
var tagName = 'mj-invoice-item';
var parentTag = ['mj-invoice'];
var endingTag = true;
...
&nbsp;
var InvoiceItem = (0, _mjmlCore.MJMLElement)(_class = function (_Component) {
  _inherits(InvoiceItem, _Component);
&nbsp;
<span class="fstat-no" title="function not covered" >  function InvoiceItem() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, InvoiceItem);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InvoiceItem.__proto__ || Object.getPrototypeOf(InvoiceItem)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      styles.name = _mjmlCore.helpers.merge({}, styles.td, styles.name);</span>
<span class="cstat-no" title="statement not covered" >      styles.quantity = _mjmlCore.helpers.merge({}, styles.td, styles.quantity);</span>
&nbsp;
