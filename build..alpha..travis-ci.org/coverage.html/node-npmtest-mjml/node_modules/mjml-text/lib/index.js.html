...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-text/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-text/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">65.71% <small>(46 / 70)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-text/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  $('.mj-text-height').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var height = parseInt($(this).css('height'));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    $(_mjmlCore.helpers.startConditionalTag + '\n      &lt;table role="presentation" border="0" cellpadding="0" cellspacing="0"&gt;&lt;tr&gt;&lt;td height="' + height + '" style="vertical-align:top;height:' + height + 'px;"&gt;\n      ' + _mjmlCore.helpers.endConditionalTag).insertBefore($(this));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    $(_mjmlCore.helpers.startConditionalTag + '\n      &lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;\n      ' + _mjmlCore.helpers.endConditionalTag).insertAfter($(this));</span>
<span class="cstat-no" title="statement not covered" >    $(this).removeClass('mj-text-height').filter('[class=""]').removeAttr('class');</span>
  });
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Text.__proto__ || Object.getPrototypeOf(Text)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
  _createClass(Text, [{
    key: 'getStyles',
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var classNames = mjAttribute('height') ? 'mj-text-height' : '';</span>
&nbsp;
