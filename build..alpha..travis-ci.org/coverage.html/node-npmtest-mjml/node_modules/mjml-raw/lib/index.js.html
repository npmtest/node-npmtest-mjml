...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-raw/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-raw/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">71.88% <small>(46 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-raw/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  $('.mj-raw').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    $(this).replaceWith($(this).html());</span>
  });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Raw);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Raw.__proto__ || Object.getPrototypeOf(Raw)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Raw, [{
    key: 'getTagName',
    value: <span class="fstat-no" title="function not covered" >function getTagName() {</span>
<span class="cstat-no" title="statement not covered" >      var parentMjml = this.props.parentMjml;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      switch (parentMjml.get('tagName')) {</span>
        case 'mj-column':
<span class="cstat-no" title="statement not covered" >          return 'tr';</span>
&nbsp;
        default:
<span class="cstat-no" title="statement not covered" >          return 'noscript';</span>
      }
    }
  }, {
    key: 'render',
    value: <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >      var mjContent = this.props.mjContent;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(this.getTagName(), {</span>
        className: 'mj-raw',
