...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-navbar/lib/Link.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-navbar/lib/Link.js</span></h1>
    <h2>
        
        Statements: <span class="metric">69.7% <small>(46 / 66)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-navbar/lib/</a> &#187; Link.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  $('.mj-link').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    $(this).before('&lt;!--[if gte mso 9]&gt;\n          &lt;td style="padding: ' + $(this).data('padding') + '"&gt;\n        &lt;![endif]--&gt;').after('&lt;!--[if gte mso 9]&gt;\n          &lt;/td&gt;\n        &lt;![endif]--&gt;').removeAttr('data-padding').removeAttr('class');</span>
  });
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Link.__proto__ || Object.getPrototypeOf(Link)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
  _createClass(Link, [{
    key: 'getStyles',
