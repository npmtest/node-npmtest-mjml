...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-section/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-section/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">51.11% <small>(46 / 90)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-section/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  $('.mj-section-outlook-background').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    var url = $(this).data('url');</span>
<span class="cstat-no" title="statement not covered" >    var width = parseInt($(this).data('width'));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    $(this).removeAttr('class').removeAttr('data-url').removeAttr('data-width');</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    $(this).after(_mjmlCore.helpers.startConditionalTag + '\n        &lt;/v:textbox&gt;\n      &lt;/v:rect&gt;\n      ' + _mjmlCore.helpers.endConditionalTag);</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-section-outlook-open').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-section-outlook-line').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    var $columnDiv = $(this).next();</span>
<span class="cstat-no" title="statement not covered" >    var width = parseInt($(this).data('width'));</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-section-outlook-close').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    $(this).replaceWith(_mjmlCore.helpers.startConditionalTag + '\n      &lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;\n      ' + _mjmlCore.helpers.endConditionalTag);</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  return $;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Section.__proto__ || Object.getPrototypeOf(Section)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
  _createClass(Section, [{
    key: 'isFullWidth',
    value: <span class="fstat-no" title="function not covered" >function isFullWidth() {</span>
<span class="cstat-no" title="statement not covered" >      var mjAttribute = this.props.mjAttribute;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      return mjAttribute('full-width') == 'full-width';</span>
    }
  }, {
    key: 'getStyles',
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var background = mjAttribute('background-url') ? {</span>
...
<span class="cstat-no" title="statement not covered" >      return _mjmlCore.helpers.merge({}, baseStyles, {</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function renderFullWidthSection() {</span>
<span class="cstat-no" title="statement not covered" >      var mjAttribute = this.props.mjAttribute;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
    ...
    key: 'renderSection',
    value: <span class="fstat-no" title="function not covered" >function renderSection() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var fullWidth = this.isFullWidth();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
        'div',
...
<span class="cstat-no" title="statement not covered" >      return this.isFullWidth() ? this.renderFullWidthSection() : this.renderSection();</span>
    }
  }]);
&nbsp;
  return Section;
