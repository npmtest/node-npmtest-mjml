...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-navbar/lib/InlineLinks.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-navbar/lib/InlineLinks.js</span></h1>
    <h2>
        
        Statements: <span class="metric">57.14% <small>(48 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">50.85% <small>(30 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-navbar/lib/</a> &#187; InlineLinks.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  $('.mj-inline-links').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    $(this).prepend('&lt;!--[if gte mso 9]&gt;\n          &lt;table role="presentation" border="0" cellpadding="0" cellspacing="0" align="' + $(this).data('align') + '"&gt;\n            &lt;tr&gt;\n        &lt;![endif]--&gt;').append('&lt;!--[if gte mso 9]&gt;\n            &lt;/tr&gt;\n          &lt;/table&gt;\n        &lt;![endif]--&gt;').removeAttr('data-align');</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-menu-trigger').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    var id = $(this).children('label').attr('for');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    $(this).before('&lt;!--[if !mso]&gt;&lt;!--&gt;\n          &lt;input type="checkbox" id="' + id + '" class="mj-menu-checkbox" style="display:none !important; max-height:0; visibility:hidden;" /&gt;\n        &lt;!--&lt;![endif]--&gt;');</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  if ($('.mj-menu-trigger').length) {</span>
<span class="cstat-no" title="statement not covered" >    $('head').append('&lt;style type="text/css"&gt;\n        noinput.mj-menu-checkbox { display:block!important; max-height:none!important; visibility:visible!important; }\n\n        @media only screen and (max-width:480px) {\n          .mj-menu-checkbox[type="checkbox"] ~ .mj-inline-links { display:none!important; }\n          .mj-menu-checkbox[type="checkbox"]:checked ~ .mj-inline-links,\n          .mj-menu-checkbox[type="checkbox"] ~ .mj-menu-trigger { display:block!important; max-width:none!important; max-height:none!important; font-size:inherit!important; }\n          .mj-menu-checkbox[type="checkbox"] ~ .mj-inline-links &gt; a { display:block!important; }\n          .mj-menu-checkbox[type="checkbox"]:checked ~ .mj-menu-trigger .mj-menu-icon-close { display:block!important; }\n          .mj-menu-checkbox[type="checkbox"]:checked ~ .mj-menu-trigger .mj-menu-icon-open { display:none!important; }\n        }\n      &lt;/style&gt;');</span>
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function InlineLinks() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, InlineLinks);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InlineLinks.__proto__ || Object.getPrototypeOf(InlineLinks)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var baseUrl = mjAttribute('base-url');</span>
<span class="cstat-no" title="statement not covered" >      var perform = <span class="fstat-no" title="function not covered" >function perform(mjml) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (mjml.get('tagName') === 'mj-link') {</span>
<span class="cstat-no" title="statement not covered" >          mjml = mjml.setIn(['attributes', 'href'], _url2.default.resolve(baseUrl, mjml.getIn(['attributes', 'href'])));</span>
        }
...
<span class="cstat-no" title="statement not covered" >        return _react2.default.cloneElement(child, { mjml: perform(child.props.mjml) });</span>
      });
    }
  }, {
    key: 'renderHamburger',
    value: <span class="fstat-no" title="function not covered" >function renderHamburger() {</span>
<span class="cstat-no" title="statement not covered" >      var mjAttribute = this.props.mjAttribute;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var key = _crypto2.default.randomBytes(8).toString('hex');</span>
&nbsp;
