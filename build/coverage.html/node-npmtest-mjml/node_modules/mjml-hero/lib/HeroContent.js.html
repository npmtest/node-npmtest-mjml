...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-hero/lib/HeroContent.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-hero/lib/HeroContent.js</span></h1>
    <h2>
        
        Statements: <span class="metric">63.01% <small>(46 / 73)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-hero/lib/</a> &#187; HeroContent.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var $mjHeroContent = $('.mj-hero-content');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  $mjHeroContent.each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    var width = $(this).css('width');</span>
<span class="cstat-no" title="statement not covered" >    var align = $(this).data('align');</span>
<span class="cstat-no" title="statement not covered" >    var backgroundColor = $(this).data('background-color');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    $(this).before(_mjmlCore.helpers.startConditionalTag + '\n      &lt;table role="presentation" border="0" cellpadding="0" cellspacing="0" align="' + align + '" width="' + width.replace('px', '') + '" style="width:' + width + ';"&gt;&lt;tr&gt;&lt;td style="padding:0;background-color:' + backgroundColor + ';"&gt;\n      ' + _mjmlCore.helpers.endConditionalTag).after(_mjmlCore.helpers.startConditionalTag + '\n      &lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;\n      ' + _mjmlCore.helpers.endConditionalTag).removeAttr('data-background-color').removeAttr('data-align');</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  if ($mjHeroContent.length &gt; 0) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function HeroContent() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, HeroContent);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HeroContent.__proto__ || Object.getPrototypeOf(HeroContent)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
