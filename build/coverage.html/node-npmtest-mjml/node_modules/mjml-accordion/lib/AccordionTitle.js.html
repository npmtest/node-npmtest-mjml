...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-accordion/lib/AccordionTitle.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-accordion/lib/AccordionTitle.js</span></h1>
    <h2>
        
        Statements: <span class="metric">73.02% <small>(46 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-accordion/lib/</a> &#187; AccordionTitle.js</div>
</div>
<div class="body">
...
&nbsp;
var tagName = 'mj-accordion-title';
var endingTag = true;
...
&nbsp;
var AccordionTitle = (0, _mjmlCore.MJMLElement)(_class = function (_Component) {
  _inherits(AccordionTitle, _Component);
&nbsp;
<span class="fstat-no" title="function not covered" >  function AccordionTitle() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, AccordionTitle);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AccordionTitle.__proto__ || Object.getPrototypeOf(AccordionTitle)).call.apply(_ref, [this].concat(args))), _this), _this.styles = _this.getStyles(), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (0, _merge2.default)({}, baseStyles, {</span>
        td: {
