...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-wrapper/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-wrapper/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">63.64% <small>(28 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">40% <small>(10 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-wrapper/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  $('.mj-wrapper-outlook-open').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-wrapper-outlook-line').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    var width = parseInt($(this).data('width'));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    $(this).replaceWith(_mjmlCore.helpers.startConditionalTag + '\n      &lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td style="width:' + width + 'px;"&gt;\n      ' + _mjmlCore.helpers.endConditionalTag);</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  $('.mj-wrapper-outlook-close').each(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    $(this).replaceWith(_mjmlCore.helpers.startConditionalTag + '\n      &lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;\n      ' + _mjmlCore.helpers.endConditionalTag);</span>
  });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Wrapper);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Wrapper.__proto__ || Object.getPrototypeOf(Wrapper)).apply(this, arguments));</span>
  }
&nbsp;
  return Wrapper;
