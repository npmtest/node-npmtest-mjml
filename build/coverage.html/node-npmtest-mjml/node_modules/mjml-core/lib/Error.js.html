...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-core/lib/Error.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-core/lib/Error.js</span></h1>
    <h2>
        
        Statements: <span class="metric">66.67% <small>(36 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-core/lib/</a> &#187; Error.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function MJMLError(message) {</span>
<span class="cstat-no" title="statement not covered" >      _classCallCheck(this, MJMLError);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _this = _possibleConstructorReturn(this, (MJMLError.__proto__ || Object.getPrototypeOf(MJMLError)).call(this, '[MJMLError] ' + name + ': ' + message));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _this.status = code;</span>
...
var warning = <span class="fstat-no" title="function not covered" >function warning(name) {</span>
...
<span class="cstat-no" title="statement not covered" >    console.error('[MJMLWarning] ' + name + ': ' + message); </span>// eslint-disable-line no-console
  };
};
...
<span class="fstat-no" title="function not covered" >  function MJMLValidationError(errors) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, MJMLValidationError);</span>
&nbsp;
...
&nbsp;
  _createClass(MJMLValidationError, [{
    key: 'getMessages',
    value: <span class="fstat-no" title="function not covered" >function getMessages() {</span>
<span class="cstat-no" title="statement not covered" >      return this.errors.map(<span class="fstat-no" title="function not covered" >function (error) {</span></span>
<span class="cstat-no" title="statement not covered" >        return error.formattedMessage;</span>
      });
    }
  }, {
    key: 'getErrors',
    value: <span class="fstat-no" title="function not covered" >function getErrors() {</span>
