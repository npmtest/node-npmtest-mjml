...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mjml/node_modules/mjml-core/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mjml/node_modules/mjml-core/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mjml/node_modules/mjml-core/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
var _MJMLElement2 = require('./decorators/MJMLElement');
&nbsp;
...
var documentParser = exports.documentParser = <span class="fstat-no" title="function not covered" >function documentParser(content, attributes) {</span>
<span class="cstat-no" title="statement not covered" >  var documentParser = require('./parsers/document').default;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return documentParser(content, attributes);</span>
};
var version = exports.version = <span class="fstat-no" title="function not covered" >function version() {</span>
<span class="cstat-no" title="statement not covered" >  return '3.3.0';</span>
};
var MJMLValidator = exports.MJMLValidator = _mjmlValidator2.default;
var mjml2html = exports.mjml2html = <span class="fstat-no" title="function not covered" >function mjml2html(mjml) {</span>
<span class="cstat-no" title="statement not covered" >  var options = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : {};</span>
<span class="cstat-no" title="statement not covered" >  return new _MJMLRenderer2.default(mjml, options).render();</span>
};
&nbsp;</pre></td></tr>
</table></pre>
</div>
